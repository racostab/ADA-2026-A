...
def stable_match(pref_1, pref_2):
    ...
    personas_libres = list(pref_1.keys())
    ...
    matches = {p1: p2 for p2, p1 in parejas_hechas.items()}
    return matches
...
pref_hombres = listas_preferencia(np)
